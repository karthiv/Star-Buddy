...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_StelTexture_t, stringdata) + ofs \
...
const QMetaObject StelTexture::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_StelTexture.data,
      qt_meta_data_StelTexture,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_StelTexture.stringdata))
