...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_CustomDeltaTEquationDialog_t, stringdata) + ofs \
...
QT_MOC_LITERAL(10, 102, 9)
    ...
    "setYear\0setCoeffA\0setCoeffB\0setCoeffC\0"
};
...
const QMetaObject CustomDeltaTEquationDialog::staticMetaObject = {
    { &StelDialog::staticMetaObject, qt_meta_stringdata_CustomDeltaTEquationDialog.data,
      qt_meta_data_CustomDeltaTEquationDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CustomDeltaTEquationDialog.stringdata))
