...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_MilkyWay_t, stringdata) + ofs \
...
QT_MOC_LITERAL(10, 85, 1),
QT_MOC_LITERAL(11, 87, 11)
    },
...
const QMetaObject MilkyWay::staticMetaObject = {
    { &StelModule::staticMetaObject, qt_meta_stringdata_MilkyWay.data,
      qt_meta_data_MilkyWay,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MilkyWay.stringdata))
