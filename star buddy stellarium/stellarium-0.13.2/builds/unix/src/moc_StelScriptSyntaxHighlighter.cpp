...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_StelScriptSyntaxHighlighter_t, stringdata) + ofs \
...
const QMetaObject StelScriptSyntaxHighlighter::staticMetaObject = {
    { &QSyntaxHighlighter::staticMetaObject, qt_meta_stringdata_StelScriptSyntaxHighlighter.data,
      qt_meta_data_StelScriptSyntaxHighlighter,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_StelScriptSyntaxHighlighter.stringdata))
