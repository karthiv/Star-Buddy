...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_StelAudioMgr_t, stringdata) + ofs \
...
QT_MOC_LITERAL(8, 67, 9)
    ...
    "playSound\0pauseSound\0stopSound\0dropSound\0"
};
...
const QMetaObject StelAudioMgr::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_StelAudioMgr.data,
      qt_meta_data_StelAudioMgr,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_StelAudioMgr.stringdata))
