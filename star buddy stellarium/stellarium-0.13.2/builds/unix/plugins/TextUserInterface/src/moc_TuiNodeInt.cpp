...
struct qt_meta_stringdata_TuiNodeInt_t {
    QByteArrayData data[4];
    char stringdata[24];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_TuiNodeInt_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_TuiNodeInt_t qt_meta_stringdata_TuiNodeInt = {
    {
...
void TuiNodeInt::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (TuiNodeInt::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TuiNodeInt::setValue)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject TuiNodeInt::staticMetaObject = {
    { &TuiNodeEditable::staticMetaObject, qt_meta_stringdata_TuiNodeInt.data,
      qt_meta_data_TuiNodeInt,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_TuiNodeInt.stringdata))
