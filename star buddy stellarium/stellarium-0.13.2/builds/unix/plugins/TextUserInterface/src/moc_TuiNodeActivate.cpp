...
struct qt_meta_stringdata_TuiNodeActivate_t {
    QByteArrayData data[3];
    char stringdata[27];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_TuiNodeActivate_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_TuiNodeActivate_t qt_meta_stringdata_TuiNodeActivate = {
    {
QT_MOC_LITERAL(0, 0, 15),
QT_MOC_LITERAL(1, 16, 8),
QT_MOC_LITERAL(2, 25, 0)
    },
    "TuiNodeActivate\0activate\0\0"
};
...
void TuiNodeActivate::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (TuiNodeActivate::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TuiNodeActivate::activate)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject TuiNodeActivate::staticMetaObject = {
    { &TuiNode::staticMetaObject, qt_meta_stringdata_TuiNodeActivate.data,
      qt_meta_data_TuiNodeActivate,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_TuiNodeActivate.stringdata))
