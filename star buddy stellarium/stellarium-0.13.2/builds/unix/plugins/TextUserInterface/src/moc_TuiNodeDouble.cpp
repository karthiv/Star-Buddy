...
struct qt_meta_stringdata_TuiNodeDouble_t {
    QByteArrayData data[4];
    char stringdata[27];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_TuiNodeDouble_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_TuiNodeDouble_t qt_meta_stringdata_TuiNodeDouble = {
    {
...
QT_MOC_LITERAL(3, 24, 1)
    ...
    "TuiNodeDouble\0setValue\0\0b\0"
};
...
void TuiNodeDouble::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (TuiNodeDouble::*_t)(double );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TuiNodeDouble::setValue)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject TuiNodeDouble::staticMetaObject = {
    { &TuiNodeEditable::staticMetaObject, qt_meta_stringdata_TuiNodeDouble.data,
      qt_meta_data_TuiNodeDouble,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_TuiNodeDouble.stringdata))
