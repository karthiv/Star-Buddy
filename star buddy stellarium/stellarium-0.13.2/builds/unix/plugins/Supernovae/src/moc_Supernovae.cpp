...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Supernovae_t, stringdata) + ofs \
...
const QMetaObject Supernovae::staticMetaObject = {
    { &StelObjectModule::staticMetaObject, qt_meta_stringdata_Supernovae.data,
      qt_meta_data_Supernovae,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Supernovae.stringdata))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_SupernovaeStelPluginInterface_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
...
const QMetaObject SupernovaeStelPluginInterface::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_SupernovaeStelPluginInterface.data,
      qt_meta_data_SupernovaeStelPluginInterface,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SupernovaeStelPluginInterface.stringdata))
...
static const unsigned char qt_pluginMetaData[] = {
    ...
    0x1d, 0x00, 0x53, 0x75, 0x70, 0x65, 0x72, 0x6e,
    0x6f, 0x76, 0x61, 0x65, 0x53, 0x74, 0x65, 0x6c,
...
static const unsigned char qt_pluginMetaData[] = {
    ...
    0x61, 0x6d, 0x65, 0x00, 0x1d, 0x00, 0x53, 0x75,
    0x70, 0x65, 0x72, 0x6e, 0x6f, 0x76, 0x61, 0x65,
