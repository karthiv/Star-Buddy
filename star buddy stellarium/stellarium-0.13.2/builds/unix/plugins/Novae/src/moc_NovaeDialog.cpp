...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_NovaeDialog_t, stringdata) + ofs \
...
QT_MOC_LITERAL(8, 95, 19),
QT_MOC_LITERAL(9, 115, 18),
QT_MOC_LITERAL(10, 134, 5),
QT_MOC_LITERAL(11, 140, 22),
QT_MOC_LITERAL(12, 163, 15),
QT_MOC_LITERAL(13, 179, 12),
QT_MOC_LITERAL(14, 192, 10)
    },
...
const QMetaObject NovaeDialog::staticMetaObject = {
    { &StelDialog::staticMetaObject, qt_meta_stringdata_NovaeDialog.data,
      qt_meta_data_NovaeDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_NovaeDialog.stringdata))
