...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_SatellitesListFilterModel_t, stringdata) + ofs \
...
const QMetaObject SatellitesListFilterModel::staticMetaObject = {
    { &QSortFilterProxyModel::staticMetaObject, qt_meta_stringdata_SatellitesListFilterModel.data,
      qt_meta_data_SatellitesListFilterModel,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SatellitesListFilterModel.stringdata))
...
int SatellitesListFilterModel::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_id < 0)
     ...
     if (_c == QMetaObject::ReadProperty) {
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< SatFlag*>(_v) = getFilterFlag(); break;
        case 1: *reinterpret_cast< QString*>(_v) = getFilterGroup(); break;
        }
        _id -= 2;
    } else if (_c == QMetaObject::WriteProperty) {
        void *_v = _a[0];
        switch (_id) {
        case 0: setFilterFlag(*reinterpret_cast< SatFlag*>(_v)); break;
        case 1: setFilterGroup(*reinterpret_cast< QString*>(_v)); break;
        }
        _id -= 2;
