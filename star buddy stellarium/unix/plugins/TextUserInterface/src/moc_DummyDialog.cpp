...
struct qt_meta_stringdata_DummyDialog_t {
    QByteArrayData data[5];
    char stringdata[46];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_DummyDialog_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_DummyDialog_t qt_meta_stringdata_DummyDialog = {
    {
...
QT_MOC_LITERAL(4, 39, 5)
    ...
    "DummyDialog\0visibleChanged\0\0setVisible\0"
    "close\0"
};
...
void DummyDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (DummyDialog::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DummyDialog::visibleChanged)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject DummyDialog::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_DummyDialog.data,
      qt_meta_data_DummyDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_DummyDialog.stringdata))
