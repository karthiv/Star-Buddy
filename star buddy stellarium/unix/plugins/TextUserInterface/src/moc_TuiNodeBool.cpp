...
struct qt_meta_stringdata_TuiNodeBool_t {
    QByteArrayData data[4];
    char stringdata[25];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_TuiNodeBool_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_TuiNodeBool_t qt_meta_stringdata_TuiNodeBool = {
    {
...
void TuiNodeBool::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (TuiNodeBool::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TuiNodeBool::setValue)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject TuiNodeBool::staticMetaObject = {
    { &TuiNodeEditable::staticMetaObject, qt_meta_stringdata_TuiNodeBool.data,
      qt_meta_data_TuiNodeBool,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_TuiNodeBool.stringdata))
