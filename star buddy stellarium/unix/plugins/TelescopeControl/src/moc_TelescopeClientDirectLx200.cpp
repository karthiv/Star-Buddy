...
struct qt_meta_stringdata_TelescopeClientDirectLx200_t {
    QByteArrayData data[1];
    char stringdata[28];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_TelescopeClientDirectLx200_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_TelescopeClientDirectLx200_t qt_meta_stringdata_TelescopeClientDirectLx200 = {
    {
...
const QMetaObject TelescopeClientDirectLx200::staticMetaObject = {
    { &TelescopeClient::staticMetaObject, qt_meta_stringdata_TelescopeClientDirectLx200.data,
      qt_meta_data_TelescopeClientDirectLx200,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_TelescopeClientDirectLx200.stringdata))
