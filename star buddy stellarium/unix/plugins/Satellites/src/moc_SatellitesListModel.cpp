...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_SatellitesListModel_t, stringdata) + ofs \
...
const QMetaObject SatellitesListModel::staticMetaObject = {
    { &QAbstractTableModel::staticMetaObject, qt_meta_stringdata_SatellitesListModel.data,
      qt_meta_data_SatellitesListModel,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SatellitesListModel.stringdata))
