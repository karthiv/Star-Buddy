/********************************************************************************
** Form generated from reading UI file 'novaeDialog.ui'
**
...
#ifndef UI_NOVAEDIALOG_H
#define UI_NOVAEDIALOG_H
...
public:
    ...
    void setupUi(QWidget *novaeDialog)
    {
        if (novaeDialog->objectName().isEmpty())
            novaeDialog->setObjectName(QStringLiteral("novaeDialog"));
        novaeDialog->resize(537, 465);
        verticalLayout_2 = new QVBoxLayout(novaeDialog);
        verticalLayout_2->setSpacing(0);
        verticalLayout_2->setContentsMargins(0, 0, 0, 0);
        verticalLayout_2->setObjectName(QStringLiteral("verticalLayout_2"));
        TitleBar = new BarFrame(novaeDialog);
        ...
        tabs = new QTabWidget(novaeDialog);
        ...
        retranslateUi(novaeDialog);

        tabs->setCurrentIndex(0);


        QMetaObject::connectSlotsByName(novaeDialog);
    } // setupUi

    void retranslateUi(QWidget *novaeDialog)
    {
        novaeDialog->setWindowTitle(QApplication::translate("novaeDialog", "Bright Novae Configuration", 0));
        stelWindowTitle->setText(QApplication::translate("novaeDialog", "Bright Novae Plug-in Configuration", 0));
        closeStelWindow->setText(QString());
        updatesGroup->setTitle(QApplication::translate("novaeDialog", "Update catalog from Internet", 0));
        internetUpdatesCheckbox->setText(QApplication::translate("novaeDialog", "Update from Internet sources", 0));
        lastUpdateLabel->setText(QApplication::translate("novaeDialog", "Last update:", 0));
        updateFrequencyLabel->setText(QApplication::translate("novaeDialog", "Update frequency (days):", 0));
        nextUpdateLabel->setText(QApplication::translate("novaeDialog", "[next update info]", 0));
        updateButton->setText(QApplication::translate("novaeDialog", "Update now", 0));
        restoreDefaultsButton->setText(QApplication::translate("novaeDialog", "Restore default settings", 0));
        saveSettingsButton->setText(QApplication::translate("novaeDialog", "Save settings as default", 0));
        tabs->setTabText(tabs->indexOf(settingsTab), QApplication::translate("novaeDialog", "Settings", 0));
        tabs->setTabText(tabs->indexOf(aboutTab), QApplication::translate("novaeDialog", "About", "tab in plugin windows"));
    } // retranslateUi

};

namespace Ui {
    class novaeDialog: public Ui_novaeDialog {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_NOVAEDIALOG_H
