...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_MultiLevelJsonBase_t, stringdata) + ofs \
...
const QMetaObject MultiLevelJsonBase::staticMetaObject = {
    { &StelSkyLayer::staticMetaObject, qt_meta_stringdata_MultiLevelJsonBase.data,
      qt_meta_data_MultiLevelJsonBase,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MultiLevelJsonBase.stringdata))
