...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_StelSkyLayer_t, stringdata) + ofs \
...
QT_MOC_LITERAL(5, 57, 10)
    ...
    "percentLoadedChanged\0percentage\0"
};
...
const QMetaObject StelSkyLayer::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_StelSkyLayer.data,
      qt_meta_data_StelSkyLayer,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_StelSkyLayer.stringdata))
