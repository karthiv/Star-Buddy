...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_StelObjectMgr_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 37, 34)
    },
    "StelObjectMgr\0selectedObjectChanged\0"
    "\0StelModule::StelModuleSelectAction\0"
};
...
const QMetaObject StelObjectMgr::staticMetaObject = {
    { &StelModule::staticMetaObject, qt_meta_stringdata_StelObjectMgr.data,
      qt_meta_data_StelObjectMgr,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_StelObjectMgr.stringdata))
