...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_SkyGui_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 27, 13)
    ...
    "SkyGui\0setStelStyle\0\0style\0updateBarsPos\0"
};
...
const QMetaObject SkyGui::staticMetaObject = {
    { &QGraphicsWidget::staticMetaObject, qt_meta_stringdata_SkyGui.data,
      qt_meta_data_SkyGui,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SkyGui.stringdata))
